  ...
  <div>
    ...
    <main class="min-h-screen pt-48 pb-20">
      <div class="max-w-7xl mx-auto px-6 md:px-8">
        <p class="font-display font-bold uppercase tracking-[0.3em] text-rally-yellow text-sm mb-2">RPP 2026</p>
        <h1 class="font-display font-black uppercase text-rally-black text-4xl md:text-6xl mb-12">Zawodnicy<br/>RPP</h1>
