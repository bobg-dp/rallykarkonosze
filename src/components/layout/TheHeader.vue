  ...
  >
    ...
    >
      ...
      <div class="relative z-10 hidden md:flex items-center gap-4">
        ...
        <div class="ml-4 flex flex-col items-center gap-0.5">
          <a
            href="https://rallydevil.com/rajd/amg-rally-karkonosze-2026-rajd-okregowy/wyniki"
            class="bg-rally-yellow text-rally-black font-display font-bold uppercase tracking-wider text-sm px-4 py-2 hover:bg-rally-yellow-dark transition-colors duration-200"
          >
            Wyniki Online
          </a>
          <a
          ...
          >
            <span class="text-[12px] font-display text-rally-black tracking-wide leading-none"><i>Napędzane przez <b>RallDevil.com</b></i></span>
