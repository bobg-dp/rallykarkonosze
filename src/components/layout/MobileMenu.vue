<template>
  <div class="py-4 px-6">
    ...
    <div class="flex items-center gap-4 mb-4 pb-4 border-b border-rally-gray">
      ...
      <a href="https://rallydevil.com/rajd/amg-rally-karkonosze-2026-rajd-okregowy/wyniki" class="ml-auto bg-rally-yellow text-rally-black font-display font-bold uppercase text-xs px-4 py-2 tracking-wider">Wyniki Online</a>
    </div>
